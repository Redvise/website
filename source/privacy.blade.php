...
@section('body')
    ...
    <div class="text-center my-5">
        ...
        <h6 class="small text-muted">Last updated: March 18, 2021</h6>
    </div>
    ...
    <div class="container">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Redvise Ltd., 71-75 Shelton Street, Covent Garden, London, WC2H 9JQ, United-Kingdom.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Redvise Ltd., accessible from <a href="https://redvi.se/" rel="external nofollow noopener" target="_blank">https://redvi.se/</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>
                    ...
                    <u>Type</u>: Session Cookies<br>
                    <u>Administered by</u>: Us<br>
                    <u>Purpose</u>: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.
                </p>
            </li>
            <li>
                <p>
                    <strong>Cookies Policy / Notice Acceptance Cookies</strong><br>
                    <u>Type</u>: Persistent Cookies<br>
                    <u>Administered by</u>: Us<br>
                    <u>Purpose</u>: These Cookies identify if users have accepted the use of cookies on the Website.
                </p>
            </li>
            <li>
                <p>
                    ...
                    <u>Type</u>: Persistent Cookies<br>
                    <u>Administered by</u>: Us<br>
                    <u>Purpose</u>: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.
                </p>
            </li>
        </ul>
        ...
        <ul>
            <li>By email: {{ $page->meta['privacy_email'] }}</li>
            <li>By visiting this page on our website: <a href="{{ url('privacy') }}" rel="external nofollow noopener" target="_blank">{{ url('privacy') }}</a></li>
        </ul>
    </div>
@endsection
